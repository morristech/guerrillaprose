...
public class TestServerProse {
    ...
    public void testSetProse() {
        assertThat(-1L, not(testProse.getId()));
    }
    ...
    public void testUpdateProse() {
        ...
        assertThat(-1L, not(testProse.getId()));
        assertThat(mProseDao.load(testProse.getId()).getTitle(),
                not(guerrillaService.getProse(testProse.getId()).getTitle()));
    ...
    public void testGetProses() {
        assertNotNull(guerrillaService.getProses());
    }


    @Test
    public void testGetProse() {
        assertNotNull(guerrillaService.getProse(testProse.getId()));
    }
